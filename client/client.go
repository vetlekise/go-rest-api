...
// GetTodo sends a GET request to the 'todos/1' endpoint and returns the response body.
...
// PostPost sends a POST request to the 'posts' endpoint and returns the response body.
